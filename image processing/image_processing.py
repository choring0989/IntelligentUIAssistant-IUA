...
def rectangle_contour(filename):
    ...
    adaptive_gaussian_image = cv.adaptiveThreshold(imag_gray, 255, cv.ADAPTIVE_THRESH_GAUSSIAN_C,cv.THRESH_BINARY_INV,  block_size, subtract_val)
    ...
    iteration= 1
    img_binary_morph = cv.morphologyEx(erd, cv.MORPH_CLOSE, kernel,iteration)
